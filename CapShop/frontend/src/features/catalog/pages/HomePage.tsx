...
export const HomePage = () => {
  ...
  const openCategory = (categoryName: string) => {
    ...
    const target = category
      ? `${ROUTES.CUSTOMER.PRODUCTS}?categoryId=${category.id}`
      : `${ROUTES.CUSTOMER.PRODUCTS}?query=${encodeURIComponent(categoryName)}`;
        ...
        <section className="mt-4 mb-10 flex gap-4 overflow-x-auto pb-2 snap-x hide-scrollbar">
          ...
          >
            <div className="relative z-10 w-2/3">
              <h2 className="text-2xl sm:text-3xl font-extrabold leading-tight mb-2 font-display">Smart gadgets<br/>for every day</h2>
              <p className="text-sm opacity-90 mb-4 font-medium">Headphones, accessories & tech deals</p>
          ...
          >
            <div className="relative z-10 w-2/3">
              <h2 className="text-2xl sm:text-3xl font-extrabold leading-tight mb-2 font-display">Latest mobiles<br/>ready to ship</h2>
              <p className="text-sm opacity-90 mb-4 font-medium">Phones, chargers, cases & more</p>
          ...
          {/* Banner 3 (Optional extra on large screens) */}
           ...
           >
            <div className="relative z-10 w-2/3">
              <h2 className="text-2xl sm:text-3xl font-extrabold leading-tight mb-2 font-display">Skincare picks<br/>for your routine</h2>
              <p className="text-sm opacity-90 mb-4 font-medium">Sunscreen, face wash, serums & more</p>
